...
var _requestPhoneResponseHandler = require('../../../src/response-handlers/cli/request-phone-response-handler');
...
var responseObject = new _requestPhoneResponse2.default();
...
_ava2.default.cb('calls inquirer library with correct parameters', function (t) {
  ...
  var h = new _requestPhoneResponseHandler2.default({
  ...
  var assert = function assert(resultValue) {
    ...
    t.is(_rec._expr(_rec._capt(resultValue, 'arguments/0'), {
      ...
      filepath: 'test/response-handlers/cli/request-phone-response-handler-test.js',
      line: 51
    }), '123');
    t.truthy(_rec2._expr(_rec2._capt(_rec2._capt(_rec2._capt(lib, 'arguments/0/callee/object/object').prompt, 'arguments/0/callee/object').calledWith(_rec2._capt([_rec2._capt({
      ...
      content: 't.truthy(lib.prompt.calledWith([{ type: \'input\', name: \'phone\', message: \'Your phone number\', default: \'(555) 111-22-33\' }]))',
      filepath: 'test/response-handlers/cli/request-phone-response-handler-test.js',
      line: 52
    }));
    t.end();
...
_ava2.default.cb('handles error while using inquirer library', function (t) {
  ...
  var assert = function assert(actualMessage) {
    ...
    var expectedMessage = 'Error in RequestPhoneResponseHandler: ' + err;
...
//# sourceMappingURL=../../../node_modules/.cache/ava/4da954e5f7754d5ab599fa044fc6a140.js.map