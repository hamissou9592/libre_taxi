...
PromptUI.prototype.run = function (questions) {
  ...
  return this.process
    ...
    .catch(this.onInterruption.bind(this)); // catch rejected promise, so undefined will be returned
};
...
PromptUI.prototype.onInterruption = function (onResult) {
  inquirer.clearInterruptPrompt();
  this.close();
  if (onResult) setTimeout(onResult, 100);
  return;
};
